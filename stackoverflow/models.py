...
class SOPosts(models.Model):
    ...
    accepted_answer = models.ForeignKey('self', blank=True, null=True, db_column='accepted_answer_id', related_name='accepted_question')
    creation_date = models.DateField(blank=True, null=True)
    score = models.SmallIntegerField(blank=True, null=True)
    view_count = models.IntegerField(blank=True, null=True)
    body = models.TextField(blank=True)
    owner_user = models.ForeignKey('SOUsers',blank=True, null=True, db_column='owner_user_id', related_name='owned_posts')
